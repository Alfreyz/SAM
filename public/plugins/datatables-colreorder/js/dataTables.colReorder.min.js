...
(function (e) {
        ...
        if (b != d)
            if (0 > b || b >= i)
                ...
                for (g = a.aaSorting.length; c < g; c++)
                    a.aaSorting[c][0] = m[a.aaSorting[c][0]];
                ...
                for (g = i; c < g; c++) {
                    k = a.aoColumns[c];
                    j = 0;
                    for (l = k.aDataSort.length; j < l; j++)
                        k.aDataSort[j] = m[k.aDataSort[j]];
                    k.idx = m[k.idx];
                }
                ...
                if (a.aoColumns[b].bVisible) {
                    ...
                    for (g = a.aoData.length; c < g; c++)
                        null !== a.aoData[c].nTr && t(a.aoData[c].nTr, n, l);
                }
                q(a.aoColumns, b, d);
                c = 0;
    ...
    e.extend(i.prototype, {
        ...
        fnOrder: function (a, b) {
            ...
            if (a === s) {
                ...
                for (h = c.length; f < h; f++)
                    d.push(c[f]._ColReorder_iOrigCol);
                return d;
            }
            if (b) {
                c = this.fnOrder();
        ...
        _fnConstruct: function () {
            ...
            if (h)
                if (a.s.dt._bInitComplete)
                    (b = r(h)), a._fnOrderColumns.call(a, b);
                else {
                    var c = !1;
        ...
        _fnOrderColumns: function (a) {
            ...
            if (a.length != this.s.dt.aoColumns.length)
                ...
                for (var d = 0, f = a.length; d < f; d++) {
                    ...
                    d != h &&
                        (q(a, h, d),
                        this.s.dt.oInstance.fnColReorder(h, d, !0, !1),
                        (b = !0));
                }
        ...
        _fnStateSave: function (a) {
            ...
            if (a.aaSorting) {
                for (b = 0; b < a.aaSorting.length; b++)
                    a.aaSorting[b][0] =
                        h[a.aaSorting[b][0]]._ColReorder_iOrigCol;
                ...
                for (b = 0; b < a.order.length; b++)
                    a.order[b][0] = h[a.order[b][0]]._ColReorder_iOrigCol;
        ...
        _fnMouseMove: function (a) {
            ...
            d
                ? (this.dom.pointer.css("left", d.x),
                  (this.s.mouse.toIndex = d.to))
                : (this.dom.pointer.css("left", h().x),
                  (this.s.mouse.toIndex = h().to));
        ...
        _fnCreateDragNode: function () {
            ...
            this.dom.drag = e(h.cloneNode(!1))
                ...
                .append(
                    e(f.cloneNode(!1)).append(e(d.cloneNode(!1)).append(c[0])),
                )
                .css({
                    position: "absolute",
                    top: 0,
