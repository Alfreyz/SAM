...
$jscomp.makeIterator = function (n) {
    var q =
        "undefined" != typeof Symbol && Symbol.iterator && n[Symbol.iterator];
        ...
        return n
            ...
            : function (q, l) {
                  return (
                      -1 !==
                      $jscomp
                          .checkStringArgs(this, q, "includes")
                          .indexOf(q, l || 0)
                  );
              };
    },
    ...
    var l,
        ...
        t = (function () {
            function h(a, b, c, e, d, f) {
                ...
                this.dom = {
                    ...
                    collapseButton: l(
                        '<button type="button"><span class="dtsp-caret">&#x5e;</span></button>',
                    )
                        .addClass(this.classes.paneButton)
                    ...
                    searchLabelCont: l("<div/>").addClass(
                ...
                e = l('<button type="button">X</button>').addClass(
                ...
                this.s.searchFunction = function (m, x, z, y) {
                    ...
                    g.colExists &&
                        ...
                        "filter" !== k.orthogonal.filter &&
                            ...
                            m instanceof l.fn.dataTable.Api &&
                                (m = m.toArray())));
            ...
            h.prototype.addRow = function (a, b, c, e, d, f, g) {
                ...
                void 0 === k &&
                    ((k = this.s.indexes.length),
                    this.s.indexes.push({ filter: b, index: k }));
            ...
            h.prototype.collapse = function () {
                ...
                this.s.displayed &&
                    ...
                    l(this.s.dtPane.table().container()).addClass(
                        this.classes.hidden,
                    ),
            ...
            h.prototype.destroy = function () {
                ...
                for (
                    var a = l.fn.dataTable.ext.search.indexOf(
                    ...
                    l.fn.dataTable.ext.search.splice(a, 1),
                        (a = l.fn.dataTable.ext.search.indexOf(
                            this.s.searchFunction,
                        ));
            ...
            h.prototype.rebuildPane = function (a, b, c, e) {
                ...
                this.s.displayed = !1;
                this._buildPane(
                    this.s.dt.page.info().serverSide ? this.s.serverSelect : d,
                    a,
                    b,
                    c,
                    f,
            ...
            h.prototype.show = function () {
                this.s.displayed &&
                    ...
                    l(this.s.dtPane.table().container()).removeClass(
                        this.classes.hidden,
                    ),
                    this.dom.topRow.removeClass(this.classes.bordered),
                    this.dom.countButton.removeClass(
                        this.classes.disabledButton,
                    ),
                    this.dom.nameButton.removeClass(
                        this.classes.disabledButton,
                    ),
                    this.dom.searchButton.removeClass(
                        this.classes.disabledButton,
                    ));
            };
                    ...
                    c = setTimeout(function () {
                        ...
                        a.s.dt.page.info().serverSide && !a.s.updating
                            ...
                            : ((a.s.deselect = !0),
                              ...
                              (a.s.deselect = !1));
                        0 ===
                            a.s.dtPane.rows({ selected: !0 }).data().toArray()
                                .length &&
                            a.dom.clear
                    ...
                    this.s.dt.on("stateSaveParams.dtsp", function (e, d, f) {
                        if (l.isEmptyObject(f)) a.s.dtPane.state.clear();
                            ...
                            if (void 0 !== a.s.dtPane) {
                                ...
                                var x = a.dom.collapseButton.hasClass(
                                    a.classes.rotated,
                                );
                            }
                            void 0 === f.searchPanes && (f.searchPanes = {});
                            void 0 === f.searchPanes.panes &&
                                (f.searchPanes.panes = []);
                            for (d = 0; d < f.searchPanes.panes.length; d++)
                                f.searchPanes.panes[d].id === a.s.index &&
                                    (f.searchPanes.panes.splice(d, 1), d--);
            ...
            h.prototype._buildPane = function (a, b, c, e, d) {
                                ...
                                (w = b[u]),
                                    ...
                                    (this.s.rowData.bins[w.value] =
                                        this.c.viewTotal || this.c.cascadePanes
                                            ? w.count
                                            : w.total),
                                    (this.s.rowData.binsTotal[w.value] =
                                        w.total);
                            ...
                            columnDefs: [
                                {
                                    ...
                                    render: function (C, G, D) {
                                        ...
                                        for (
                                            E = E.replace(/{shown}/, D.shown);
                                            E.includes("{total}");

                                        )
                                            E = E.replace(/{total}/, D.total);
                                        for (; E.includes("{shown}"); )
                                            E = E.replace(/{shown}/, D.shown);
                                        D =
                                            '<span class="' +
                                            f.classes.pill +
                ...
                if (this.colExists) {
                    ...
                    for (d = m.arrayFilter.length; u < d; u++) {
                        ...
                        if (
                            ...
                            (!this.c.cascadePanes ||
                                (this.c.cascadePanes &&
                                    0 !== m.bins[m.arrayFilter[u].filter]) ||
                            ...
                            this.s.dt.page.info().serverSide ||
                            !m.arrayFilter[u] ||
                            (void 0 === m.bins[m.arrayFilter[u].filter] &&
                                this.c.cascadePanes)
                                ? this.s.dt.page.info().serverSide ||
                                  this.addRow("", B, B, "", "", "")
                                : this.addRow(
                ...
                for (e = 0; e < a.length; e++)
                    if (((m = a[e]), void 0 !== m))
                        for (
                            u = 0, d = this.s.dtPane.rows().indexes().toArray();
                            u < d.length;
                            u++
                        )
                            (k = d[u]),
                                void 0 !== this.s.dtPane.row(k).data() &&
                                    m.filter ===
                                        this.s.dtPane.row(k).data().filter &&
                                    (this.s.dt.page.info().serverSide
                                        ? ((this.s.serverSelecting = !0),
                ...
                ((this.c.initCollapsed &&
                    !1 !== this.s.colOpts.initCollapsed) ||
                        ...
                        (a = y[c]),
                            a.id === this.s.index &&
                                (a.searchTerm &&
                                    ...
                                    (this.dom.searchBox.val(a.searchTerm),
                    ...
                    for (var g = 0; g < a.length; g++) {
                        ...
                        if ("function" === typeof k.value) {
                            for (var B = 0; B < b.length; B++)
                                k.value.call(this.s.dt, b[B], c[0][B]) && y++;
                            for (B = 0; B < e.length; B++)
                                k.value.call(this.s.dt, e[B], d[0][B]) && u++;
                ...
                if ("string" === typeof d.orthogonal)
                    ...
                    e[f]
                        ...
                        : ((e[f] = 1),
                          this._addOption(
                              f,
                              c.oApi._fnGetCellData(
                                  c,
                                  a,
                                  this.s.index,
                                  d.orthogonal.display,
                              ),
                              c.oApi._fnGetCellData(
                                  c,
                                  a,
            ...
            h.prototype._updateCommon = function (a) {
                ...
                if (
                    ...
                    if (
                        (void 0 !== a.searchPanes &&
                            void 0 !== a.searchPanes.options) ||
                        void 0 !== a.options ||
                        (null !== this.customPaneSettings &&
                            void 0 !== this.customPaneSettings.options)
                    )
        ...
        F = (function () {
                ...
                if (void 0 === d.settings()[0]._searchPanes) {
                    ...
                    if (this.s.dt.page.info().serverSide)
                        d.on("preXhr.dt", function (f, g, k) {
                            ...
                            void 0 === k.searchPanes_null &&
                                (k.searchPanes_null = {});
                            f = 0;
                            for (g = e.s.selectionList; f < g.length; f++) {
                                var p = g[f],
                                    m = e.s.dt.column(p.index).dataSrc();
                                void 0 === k.searchPanes[m] &&
                                    (k.searchPanes[m] = {});
                                void 0 === k.searchPanes_null[m] &&
                                    (k.searchPanes_null[m] = {});
                                for (var x = 0; x < p.rows.length; x++)
                                    (k.searchPanes[m][x] = p.rows[x].filter),
                                        null === k.searchPanes[m][x] &&
                                            (k.searchPanes_null[m][x] = !0);
                            }
                        });
                ...
                if (!this.s.updating && !this.s.dt.page.info().serverSide) {
                    ...
                    if (
                        ...
                        for (f = this.s.panes; b < f.length; b++)
                            if (((k = f[b]), void 0 !== k.s.dtPane)) {
                                ...
                                if (0 === g)
                                    for (
                                        var p = 0, m = this.s.selectionList;
                                        p < m.length;
                                        p++
                                    ) {
                                        var x = m[p];
                    ...
                    if (this.regenerating)
                        ...
                        for (k = 0; k < this.s.selectionList.length; k++)
                            if (
                                this.s.selectionList[k].index !== f ||
                                !0 === this.s.selectionList[k].protect
                            ) {
                                g = !1;
                                for (
                                    p = k + 1;
                                    p < this.s.selectionList.length;
                                    p++
                                )
                                    this.s.selectionList[p].index ===
                                        this.s.selectionList[k].index &&
                                        (g = !0);
                                g ||
                                    (b.push(this.s.selectionList[k]),
                                    (this.s.selectionList[k].protect = !1));
                            }
                        f = -1;
                        1 === b.length &&
                            null !== d &&
                        ...
                        if (
                            0 < b.length &&
                            (b.length < this.s.selectionList.length || a)
                        )
                            for (
                                this._cascadeRegen(b, d),
                    ...
                    for (d = this.s.panes; b < d.length; b++)
                        (g = d[b]),
                            g.s.displayed &&
                                ((f =
                                    "columns-" +
                                    (e.includes(g.s.index) ? c : a)),
                                g.resize(f));
                } else
                    for (a = 0, c = this.s.panes; a < c.length; a++)
                        (g = c[a]), g.adjustTopRow();
                return this;
            };
            h.prototype._attach = function () {
                ...
                0 === v("div." + this.classes.container).length &&
            ...
            h.prototype._cascadeRegen = function (a, b) {
                ...
                if (e !== c) {
                    d = 0;
                    for (var f = this.s.panes; d < f.length; d++)
                        (b = f[d]), (b.s.forceViewTotal = !0);
                }
                d = 0;
                for (f = this.s.panes; d < f.length; d++)
                    (b = f[d]), b.updatePane(!0);
                this._makeCascadeSelections(a);
                this.s.selectionList = a;
                a = 0;
                for (d = this.s.panes; a < d.length; a++)
                    (b = d[a]), b.setCascadeRegen(!1);
                this.regenerating = !1;
                if (e !== c)
                    for (a = 0, c = this.s.panes; a < c.length; a++)
                        (b = c[a]), (b.s.forceViewTotal = !1);
            };
            ...
            h.prototype._checkCollapse = function () {
                for (
                    var a = !0, b = !0, c = 0, e = this.s.panes;
                    c < e.length;
                    c++
                ) {
                    var d = e[c];
            ...
            h.prototype._serverTotals = function () {
                for (
                    var a = !1, b = !1, c = 0, e = this.s.panes;
                    c < e.length;
                    c++
                ) {
                    var d = e[c];
                ...
                if (a) {
                    ...
                    for (e = 0; e < this.s.selectionList.length; e++) {
                        ...
                        for (a = e + 1; a < this.s.selectionList.length; a++)
                            this.s.selectionList[a].index ===
                                this.s.selectionList[e].index && (d = !0);
                        if (!d) {
                            a = !1;
                ...
                for (e = this.s.panes; b < e.length; b++)
                    (d = e[b]),
                        ...
                        void 0 !== d.s.dtPane &&
                            ((v(
                                d.s.dtPane.table().node(),
                            ).parent()[0].scrollTop = d.s.scrollTop),
            ...
            h.prototype._startup = function (a) {
                ...
                if (
                    ...
                    for (
                        var e = !1, d = 0, f = c.searchPanes.panes;
                        d < f.length;
                        d++
                    ) {
                        var g = f[d];
                ...
                if (this.c.viewTotal && !this.c.cascadePanes)
                    for (c = 0, e = this.s.panes; c < e.length; c++)
                        (g = e[c]), g.updatePane();
                this._checkMessage();
                    ...
                    a.off("preXhr.dt"),
                        a.on("preXhr.dt", function (k, p, m) {
                            ...
                            for (var x = b.s.panes; p < x.length; p++) {
                                ...
                                void 0 === m.searchPanes[y] &&
                                    (m.searchPanes[y] = {});
                                void 0 === m.searchPanes_null[y] &&
                                    (m.searchPanes_null[y] = {});
                                if (void 0 !== z.s.dtPane) {
                                    ...
                                    for (var w = 0; w < z.length; w++)
                                        (m.searchPanes[y][w] = z[w].filter),
                                            null === m.searchPanes[y][w] &&
                                                (m.searchPanes_null[y][w] = !0),
                                            k++;
                                }
                            }
                ...
                for (e = this.s.panes; c < e.length; c++)
                    if (
                        ...
                        for (f = 0; f < d; f++)
                            (g.s.colOpts.preSelect.includes(
                                g.s.dtPane.cell(f, 0).data(),
                            ) ||
                                (null !== g.customPaneSettings &&
                                    void 0 !== g.customPaneSettings.preSelect &&
                                    g.customPaneSettings.preSelect.includes(
                                        g.s.dtPane.cell(f, 0).data(),
                                    ))) &&
                ...
                a.on("destroy.dtsps", function () {
                    for (var k = 0, p = b.s.panes; k < p.length; k++)
                        p[k].destroy();
                    a.off(".dtsps");
            ...
            h.prototype._prepViewTotal = function (a) {
                for (
                    var b = this.s.filterPane, c = !1, e = 0, d = this.s.panes;
                    e < d.length;
                    e++
                ) {
                    var f = d[e];
                                ...
                                filterChanged: function (m) {
                                    d.button(f).text(
                                        d.i18n(
                                            ...
                                            void 0 !==
                                                d.context[0].oLanguage
                                                    .searchPanes
                                                ? d.context[0].oLanguage
                                                      .searchPanes.collapse
                                                : d.context[0]._searchPanes.c
                                                      .i18n.collapse,
                                            m,
                                        ),
                                    );
