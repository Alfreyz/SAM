...
!(function () {
    ...
    var a,
        ...
        M =
            ...
            (l = {
                DATA_TOGGLE:
                    '[data-toggle="' + (r = o = "datetimepicker") + '"]',
            }),
            (c = { INPUT: o + "-input" }),
            (u = {
                CHANGE: "change" + (d = "." + r),
            ...
            (v = {
                ...
                keyBinds: {
                    ...
                    t: function () {
                        return (
                            !!this.widget && (this.date(this.getMoment()), !0)
                        );
                    },
                    delete: function () {
                ...
                return (
                    ...
                    (i._getOptions = function (t) {
                        return (t = a.extend(
                            ...
                            {},
                            v,
                            t && t.icons && "feather" === t.icons.type
                                ? { icons: b }
                                : {},
                            t,
                        ));
                    ...
                    (i._isEnabled = function (t) {
                        ...
                        switch (t) {
                            ...
                            case "d":
                                return (
                                    -1 !==
                                    this.actualFormat.toLowerCase().indexOf("d")
                                );
                            case "h":
                            case "H":
                                return (
                                    -1 !==
                                    this.actualFormat.toLowerCase().indexOf("h")
                                );
                            case "m":
                                return -1 !== this.actualFormat.indexOf("m");
                            case "s":
                            ...
                            case "A":
                                return (
                                    -1 !==
                                    this.actualFormat.toLowerCase().indexOf("a")
                                );
                            default:
                                return !1;
                        }
                    ...
                    (i._areSameDates = function (t, e) {
                        ...
                        return (
                            ...
                            e &&
                            (t.isSame(e) ||
                                n(t.format(i), i).isSame(n(e.format(i), i)))
                        );
                    }),
                    (i._notifyEvent = function (t) {
                        if (t.type === p.Event.CHANGE) {
                            if (
                                ...
                                this._notifyChangeEventContext++,
                                (t.date &&
                                    this._areSameDates(t.date, t.oldDate)) ||
                                    (!t.isClear && !t.date && !t.oldDate) ||
                                    1 < this._notifyChangeEventContext)
                            )
                                return void (this._notifyChangeEventContext =
                                    void 0);
                    ...
                    (i._showMode = function (t) {
                        this.widget &&
                            ...
                            this.widget
                                ...
                                .filter(
                                    ".datepicker-" +
                                        _[this.currentViewMode].CLASS_NAME,
                                )
                                .show());
                    }),
                    (i._isInDisabledDates = function (t) {
                        return (
                            !0 ===
                            this._options.disabledDates[t.format("YYYY-MM-DD")]
                        );
                    }),
                    (i._isInEnabledDates = function (t) {
                        return (
                            !0 ===
                            this._options.enabledDates[t.format("YYYY-MM-DD")]
                        );
                    }),
                    (i._isInDisabledHours = function (t) {
                        return (
                            !0 === this._options.disabledHours[t.format("H")]
                        );
                    }),
                    ...
                    (i._isValid = function (t, e) {
                        ...
                        if (
                            ...
                            t.isBefore(this._options.minDate, e)
                        )
                            return !1;
                        if (
                            this._options.maxDate &&
                            t.isAfter(this._options.maxDate, e)
                        )
                            return !1;
                        if (
                    ...
                    (i._keydown = function (t) {
                        ...
                        for (e in this._options.keyBinds)
                            if (
                                ...
                                "function" ==
                                    typeof this._options.keyBinds[e] &&
                    ...
                    (i.getMoment = function (t) {
                        ...
                        return (
                            this._hasTimeZone() && e.tz(this._options.timeZone),
                            e
                        );
                    }),
                    (i.toggle = function () {
                    ...
                    (i.date = function (t, e) {
                        ...
                        "string" == typeof t && y(t) && (t = new Date(t)),
                            this._setValue(
                                null === t ? null : this._parseInputDate(t),
                                e,
                            );
                    }),
                    ...
                    (i.maxDate = function (t) {
                        ...
                        if ("boolean" == typeof t && !1 === t)
                            return (
                                (this._options.maxDate = !1), this._update(), !0
                            );
                        "string" == typeof t &&
                            (("now" !== t && "moment" !== t) ||
                                (t = this.getMoment()));
                        ...
                        if (
                            this._options.minDate &&
                            e.isBefore(this._options.minDate)
                        )
                            throw new TypeError(
                    ...
                    (i.minDate = function (t) {
                        ...
                        if ("boolean" == typeof t && !1 === t)
                            return (
                                (this._options.minDate = !1), this._update(), !0
                            );
                        "string" == typeof t &&
                            (("now" !== t && "moment" !== t) ||
                                (t = this.getMoment()));
                        ...
                        if (
                            this._options.maxDate &&
                            e.isAfter(this._options.maxDate)
                        )
                            throw new TypeError(
                    ...
                    (i.viewDate = function (t) {
                        ...
                        (this._viewDate = this._parseInputDate(t)),
                            this._update(),
                            this._viewUpdate(
                                _[this.currentViewMode] &&
                                    _[this.currentViewMode].NAV_FUNCTION,
                            );
                    }),
    ...
    (E = jQuery),
            ...
            return (
                (i._init = function () {
                    ...
                    this._element.hasClass("input-group") &&
                        (0 ===
                        (t = this._element.find(".datepickerbutton")).length
                ...
                (i._place = function (t) {
                    var e,
                        ...
                        n = (
                            i.component && i.component.length
                                ? i.component
                                : i._element
                        ).position(),
                        o = (
                        ...
                        ("auto" === s &&
                            (s =
                                o.top + 1.5 * i.widget.height() >=
                                    E(window).height() +
                                        E(window).scrollTop() &&
                                i.widget.height() + i._element.outerHeight() <
                                    o.top
                                    ? "top"
                                    : "bottom"),
                        "auto" === a &&
                            (a =
                                e.width() <
                                    o.left + i.widget.outerWidth() / 2 &&
                                o.left + i.widget.outerWidth() >
                                    E(window).width()
                                    ? "right"
                                    : "left"),
                        "top" === s
                    ...
                    i.widget.css({
                        top:
                            "top" === s
                                ? "auto"
                                : n.top + i._element.outerHeight() + "px",
                        bottom:
                            "top" === s
                                ? e.outerHeight() -
                                  (e === i._element ? 0 : n.top) +
                                  "px"
                                : "auto",
                        left:
                            "left" === a
                                ? (e === i._element ? 0 : n.left) + "px"
                                : "auto",
                        right:
                            "left" === a
                                ? "auto"
                ...
                (i._fillDow = function () {
                    ...
                    for (
                        ...
                        t.append(
                            E("<th>").addClass("dow").text(e.format("dd")),
                        ),
                            e.add(1, "d");
                ...
                (i._updateYears = function () {
                    ...
                    for (
                        ...
                        (n +=
                            ...
                            (s.isSame(this._getLastPickedDate(), "y") &&
                            !this.unset
                                ? " active"
                                : "") +
                            (this._isValid(s, "y") ? "" : " disabled") +
                    ...
                    for (
                        ...
                        (t = a.year() + 11),
                            ...
                            (h +=
                                ...
                                (o && o.isAfter(a) && o.year() <= t
                                    ? " active"
                                    : "") +
                                (this._isValid(a, "y") || r || d
                                    ? ""
                                    : " disabled") +
                                '" data-selection="' +
                                (a.year() + 6) +
                    ...
                    if (this._hasDate()) {
                        for (
                            ...
                            0 === t.weekday() &&
                                ...
                                this._options.calendarWeeks &&
                                    e.append(
                                        '<td class="cw">' + t.week() + "</td>",
                                    ),
                                r.push(e)),
                                (i = ""),
                                t.isBefore(this._viewDate, "M") &&
                                    (i += " old"),
                ...
                (i._fillTime = function () {
                    ...
                    this.use24Hours ||
                        ...
                        (e = s
                            ? s.clone().add(12 <= s.hours() ? -12 : 12, "h")
                            : void 0),
                        s && t.text(s.format("A")),
                        this._isValid(e, "h")
                ...
                (i._doAction = function (t, e) {
                    ...
                    switch ((e = e || E(t.currentTarget).data("action"))) {
                        case "next":
                            var s =
                                M.DatePickerModes[this.currentViewMode]
                                    .NAV_FUNCTION;
                            this._viewDate.add(
                                M.DatePickerModes[this.currentViewMode]
                                    .NAV_STEP,
                        ...
                        case "selectDecade":
                            var r =
                                parseInt(E(t.target).data("selection"), 10) ||
                                0;
                        ...
                        case "selectDay":
                            ...
                            this._options.allowMultidate
                                ? -1 !==
                                  (p = this._datesFormatted.indexOf(
                                      h.format("YYYY-MM-DD"),
                                  ))
                        ...
                        case "incrementHours":
                            ...
                            this._isValid(l, "h") &&
                                (this._getLastPickedDateIndex() < 0 &&
                                    this.date(l),
                                this._setValue(
                                    l,
                                    this._getLastPickedDateIndex(),
                        ...
                        case "selectMinute":
                            this._setValue(
                                i
                                    .clone()
                                    .minutes(parseInt(E(t.target).text(), 10)),
                                this._getLastPickedDateIndex(),
                            ),
                                this._isEnabled("a") ||
                                this._isEnabled("s") ||
                        ...
                        case "selectSecond":
                            this._setValue(
                                i
                                    .clone()
                                    .seconds(parseInt(E(t.target).text(), 10)),
                                this._getLastPickedDateIndex(),
                            ),
                                this._isEnabled("a") ||
                                this._options.keepOpen ||
                ...
                (n._jQueryHandleThis = function (t, e, i) {
                    ...
                    if (
                        ...
                        "date" === e &&
                            (s.isDateUpdateThroughDateOptionFromClientCode =
                                !0);
                        var a = s[e](i);
                        return (
                            (s.isDateUpdateThroughDateOptionFromClientCode =
        ...
        E(document)
            ...
            .on(M.Event.CHANGE, "." + M.ClassName.INPUT, function (t) {
                ...
                0 === e.length ||
                    t.isInit ||
                    x._jQueryInterface.call(e, "_change", t);
            })
    ...
    function I(t) {
        ...
        return (
            ...
            0 === (e = E(i)).length
                ? t
                : (e.data(M.DATA_KEY) || E.extend({}, e.data(), E(this).data()),
                  e)
        );
    }
})();
