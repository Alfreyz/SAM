            ...
            (() => {
                    ...
                    var e = document.body.createTextRange(),
                        o = (function t(e, o) {
                            ...
                            if (ht.isText(e)) {
                                ...
                                if (((n = e.childNodes[o] || e), ht.isText(n)))
                                    return t(n, 0);
                                (o = 0), (i = !1);
                            }
                ...
                const kt = {
                    ...
                    createFromNode: function (t) {
                        ...
                        return (
                            ht.isVoid(e) &&
                                ((o = ht.listPrev(e).length - 1),
                                (e = e.parentNode)),
                            ht.isBR(n)
                                ? ((i = ht.listPrev(n).length - 1),
                                  (n = n.parentNode))
                                : ht.isVoid(n) &&
                                  ((i = ht.listPrev(n).length),
                                  (n = n.parentNode)),
                            this.create(e, o, n, i)
                        );
                    },
                ...
                const wt = {
                    ...
                    isMove: function (t) {
                        return y.contains(
                            [yt.LEFT, yt.UP, yt.RIGHT, yt.DOWN],
                            t,
                        );
                    },
                    isNavigation: function (t) {
                        return y.contains(
                            [yt.HOME, yt.END, yt.PAGEUP, yt.PAGEDOWN],
                            t,
                        );
                    },
                        ...
                        (n = [
                            ...
                            },
                            {
                                ...
                                value: function (t, o) {
                                    ...
                                    if (t.isCollapsed())
                                        return [t.insertNode(ht.create(n))];
                            ...
                            },
                            {
                                ...
                                value: function (t, e) {
                                    var o = y.head(t),
                                        n = y.last(t),
                                        i =
                                            ht.isList(o.previousSibling) &&
                                            o.previousSibling,
                                        r =
                                            ht.isList(n.nextSibling) &&
                                            n.nextSibling,
                                        a =
                                            i ||
                                            ht.insertAfter(
                        ...
                        (this.insertParagraph = this.wrapCommand(function () {
                            ...
                            (this.insertText = this.wrapCommand(function (t) {
                                if (!n.isLimited(t.length)) {
                                    ...
                                    n.setLastRange(
                                        kt.create(e, ht.nodeLength(e)).select(),
                                    );
                                }
                            })),
                            ...
                            (this.formatBlock = this.wrapCommand(
                                function (t, e) {
                                    var o =
                                        n.options.callbacks.onApplyCustomStyle;
                                    o
                                        ? o.call(
                                              n,
                                              e,
