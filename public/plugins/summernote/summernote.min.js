            ...
            (() => {
                ...
                function ot(t, e) {
                    ...
                    if (O(t.node) === t.offset) {
                        ...
                        ((n = t.node), (o = e ? O(t.node) : t.offset + 1), U(n))
                    )
                        return null;
                    return { node: n, offset: o };
                }
                ...
                const ht = {
                    ...
                    replace: function (t, e) {
                        ...
                        return (
                            t.style.cssText &&
                                (n.style.cssText = t.style.cssText),
                    ...
                    isCustomStyleTag: function (t) {
                        return (
                            t &&
                            !S(t) &&
                            k.contains(t.classList, "note-styletag")
                        );
                    },
                };
                function ft(t, e) {
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    ...
                                    var e,
                                        n = this.normalize();
                                    if (
                                        ht.isParaInline(this.sc) ||
                                        ht.isPara(this.sc)
                                    )
                                        return n;
                                    if (ht.isInline(n.sc)) {
                                        var o = ht.listAncestor(
                                            n.sc,
                                            v.not(ht.isInline),
                                        );
                                        (e = k.last(o)),
                ...
                const yt = {
                    ...
                    createFromNode: function (t) {
                        ...
                        return (
                            ht.isVoid(e) &&
                                ((n = ht.listPrev(e).length - 1),
                                (e = e.parentNode)),
                            ht.isBR(o)
                                ? ((i = ht.listPrev(o).length - 1),
                                  (o = o.parentNode))
                                : ht.isVoid(o) &&
                                  ((i = ht.listPrev(o).length),
                                  (o = o.parentNode)),
                            this.create(e, n, o, i)
                        );
                    },
                            ...
                            },
                            {
                                ...
                                value: function (t) {
                                    ...
                                    return (
                                        (o.anchor =
                                            t.isOnAnchor() &&
                                            ht.ancestor(t.sc, ht.isAnchor)),
                                        (o.ancestors = ht.listAncestor(
                                            t.sc,
                                            ht.isEditable,
                                        )),
                                        (o.range = t),
                            ...
                            },
                            {
                                ...
                                value: function (t, e) {
                                    var n = k.head(t),
                                        o = k.last(t),
                                        i =
                                            ht.isList(n.previousSibling) &&
                                            n.previousSibling,
                                        r =
                                            ht.isList(o.nextSibling) &&
                                            o.nextSibling,
                                        a =
                                            i ||
                                            ht.insertAfter(
                        ...
                        (o = [
                            {
                                ...
                                value: function (t, e) {
                                    var n = ht.createText(
                                        new Array(e + 1).join(ht.NBSP_CHAR),
                                    );
                        ...
                        (this.insertParagraph = this.wrapCommand(function () {
                            ...
                            (this.insertText = this.wrapCommand(function (t) {
                                if (!o.isLimited(t.length)) {
                                    var e = o
                                        .getLastRange()
                                        .insertNode(ht.createText(t));
                                    o.setLastRange(
                                        yt.create(e, ht.nodeLength(e)).select(),
                                    );
                                }
                            })),
                            ...
                            (this.formatBlock = this.wrapCommand(
                                function (t, e) {
                                    var n =
                                        o.options.callbacks.onApplyCustomStyle;
                                    n
                                        ? n.call(
                                              o,
                                              e,
                            ...
                            (this.createLink = this.wrapCommand(function (t) {
                                ...
                                if (!(l > 0 && o.isLimited(l))) {
                                    ...
                                    e().each(u, function (t, o) {
                                        ...
                                        o.setLastRange(
                                            o.createRangeFromList(u).select(),
                                        );
                                }
                            })),
                        ...
                        (o = [
                            {
                                ...
                                value: function () {
                                    ...
                                    this.$editable
                                        ...
                                        this.$editable.html(
                                            ht.html(this.$note) || ht.emptyPara,
                                        ),
                                        this.$editable.on(
                                            f.inputEventName,
                                            v.debounce(function () {
                            ...
                            },
                            {
                                ...
                                value: function (t) {
                                    var e = yt
                                            .createFromNodeBefore(k.head(t))
                                            .getStartPoint(),
                                        n = yt
                                            .createFromNodeAfter(k.last(t))
                                            .getEndPoint();
                                    return yt.create(
                                        e.node,
                                        e.offset,
                    ...
                    return (
                        ...
                        (n = [
                            ...
                            },
                            {
                                key: "handleKeyup",
                                value: function (t) {
                                    k.contains(this.keys, t.keyCode) &&
                                        this.replace();
                                },
                            },
                        ]) && te(e.prototype, n),
                        ...
                        (o = [
                            {
                                ...
                                value: function () {
                                    return (
                                        this.options.airMode &&
                                        !k.isEmpty(this.options.popover.air)
                                    );
                                },
                            },
                            {
                            ...
                            },
                            {
                                key: "update",
                                value: function (t) {
                                    var n = this.context.invoke(
                                        "editor.currentStyle",
                                    );
                                    if (
                                        !n.range ||
                                        (n.range.isCollapsed() && !t)
                                    )
                                        this.hide();
                                    else {
                                        var o = {
