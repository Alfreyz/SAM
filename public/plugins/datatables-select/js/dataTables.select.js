 ...
 */
            ...
            .on("click.dtSelect", selector, function (e) {
                ...
                if (matchSelection) {
                    ...
                    if (
                        ...
                        $(selection.anchorNode).closest("table")[0] ===
                            dt.table().node()
                    ) {
    ...
    $.each(
        ...
        function (i, o) {
            DataTable.ext.selector[o.type].push(
                function (settings, opts, indexes) {
                ...
                api.cells(null, idx)
                    ...
                    .each(function (cellIdx) {
                        ...
                        if (
                            ...
                            $(data.anCells[cellIdx.column]).removeClass(
