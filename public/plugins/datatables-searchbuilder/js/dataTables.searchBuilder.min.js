        ...
        return k
            ...
            : function (m, l) {
                  return (
                      -1 !==
                      $jscomp
                          .checkStringArgs(this, m, "includes")
                          .indexOf(m, l || 0)
                  );
              };
    },
        ...
        r = (function () {
            function c(a, b, d, e, f) {
                ...
                this.dom = {
                    ...
                    dataTitle: h(
                        '<option value="" disabled selected hidden/>',
                    ).html(this.s.dt.i18n("searchBuilder.data", b.data)),
                    ...
                    delete: h("<button/>")
                        .html(
                            this.s.dt.i18n("searchBuilder.delete", b["delete"]),
                        )
                ...
                if (this.c.greyscale)
                    for (
                        this.dom.data.addClass(this.classes.greyscale),
                            ...
                            this.dom.defaultValue.addClass(
                                this.classes.greyscale,
                            ),
                            a = 0,
                            d = this.dom.value;
                        a < d.length;
                    ...
                    if (
                        ...
                        if ("" !== this.s.dt.settings()[0].oLanguage.sThousands)
                            for (a = 0; a < e.length; a++)
                                e[a] = e[a].replace(
                                    this.s.dt.settings()[0].oLanguage
                                        .sThousands,
                                    ",",
                                );
                        e = e.join(".");
            ...
            c.prototype.getDetails = function (a) {
                ...
                if (
                    ...
                    for (a = 0; a < this.s.value.length; a++)
                        this.s.value[a] = this.s.value[a].replace(
                            /[^0-9.]/g,
                            "",
                        );
                return {
            ...
            c.prototype.rebuild = function (a) {
                ...
                if (void 0 !== a.data) {
                    ...
                    this.dom.data.children("option").each(function () {
                        ...
                        (h(this).text() === a.data ||
                            (a.origData &&
                                h(this).prop("origData") === a.origData))
                ...
                if (b) {
                    ...
                    for (
                        var g = void 0,
                            n = this.dom.condition.children("option"),
                            q = 0;
                        q < n.length;
                        q++
                    ) {
            ...
            c.prototype.setListeners = function () {
                ...
                this.dom.data.unbind("change").on("change.dtsb", function () {
                    ...
                    for (
                        var b = a.dom.data.children(
                                "option." + a.classes.option,
                            ),
                            d = 0;
                        d < b.length;
                        d++
                ...
                this.dom.condition
                    ...
                    .on("change.dtsb", function () {
                        ...
                        for (
                            var b = a.dom.condition.children(
                                    "option." + a.classes.option,
                                ),
                                d = 0;
                            d < b.length;
                                ...
                                for (f = a.dom.value; e < f.length; e++)
                                    (g = f[e]),
                                        a.s.filled &&
                                            void 0 !== g &&
                                            0 !==
                                                a.dom.container.has(g[0])
                                                    .length &&
                                            ((a.s.filled = !1),
                                            a.s.dt.draw(),
                                            a.setListeners());
                                (0 === a.dom.value.length ||
                                    (1 === a.dom.value.length &&
                                        void 0 === a.dom.value[0])) &&
                                    a.s.dt.draw();
            ...
            c.prototype._adjustCriteria = function () {
                if (0 !== h(document).has(this.dom.container).length) {
                    ...
                    if (
                        void 0 !== a &&
                        0 !== this.dom.container.has(a[0]).length
                    ) {
                        ...
                        var d = this.dom.left.offset(),
                            ...
                            n =
                                0 !==
                                this.dom.container.has(this.dom.right[0])
                                    .length,
                        ...
                        !this.dom.container
                            .parent()
                            .hasClass(this.classes.vertical)
                            ? (this.dom.container
                                  .parent()
                                  .addClass(this.classes.vertical),
            ...
            c.prototype._clearValue = function () {
                if (void 0 !== this.s.condition) {
                    ...
                    b = 0;
                    for (d = this.dom.value; b < d.length; b++)
                        (e = d[b]), a(e);
            ...
            c.prototype._getOptions = function () {
                return h.extend(
                    ...
                    {},
                    c.defaults,
                    this.s.dt.settings()[0].aoColumns[this.s.dataIdx]
                        .searchBuilder,
                );
            };
            c.prototype._populateCondition = function () {
                ...
                if (0 === b) {
                    ...
                    if (void 0 !== d)
                        if (
                            ((d = d[b]),
                            void 0 !== d.searchBuilderType &&
                                null !== d.searchBuilderType)
                        )
                    ...
                    "" !== b &&
                        this.s.type.indexOf(b) ===
                            this.s.type.length - b.length &&
                            ...
                            function (f) {
                                ...
                                if (
                                    !(
                                        a.c.enterSearch ||
                                        (void 0 !==
                                            a.s.dt.settings()[0].oInit.search &&
                                            a.s.dt.settings()[0].oInit.search[
                                                "return"
                                            ])
                                    ) ||
            ...
            c.init2Date = function (a, b, d) {
                ...
                a.c.greyscale &&
                    (f[0].addClass(c.classes.greyscale),
                    f[2].addClass(c.classes.greyscale));
                ...
                for (var b = !0, d = 0; d < a.length; d++) {
                    ...
                    e.children("option:selected").length ===
                        e.children("option").length -
                            e.children("option." + c.classes.notItalic)
                                .length &&
                        1 === e.children("option:selected").length &&
                        e.children("option:selected")[0] ===
                            e.children("option")[0] &&
                        (b = !1);
                }
                return b;
            ...
            c.inputValueSelect = function (a) {
                for (var b = [], d = 0; d < a.length; d++) {
                    ...
                    e.is("select") &&
                        b.push(
                            c._escapeHTML(
                                e.children("option:selected").data("sbv"),
                            ),
                        );
                }
                return b;
            ...
            c.updateListener = function (a, b) {
                ...
                if (a.s.filled) {
                    ...
                    null !== e &&
                        ...
                        a.dom.value[e].focus(),
                        null !== f &&
                            a.dom.value[e][0].setSelectionRange(f, f));
                } else a.s.dt.draw();
            };
            c.dateConditions = {
                "=": {
            ...
            c.stringConditions = {
                ...
                starts: {
                    ...
                    search: function (a, b) {
                        return (
                            0 === a.toLowerCase().indexOf(b[0].toLowerCase())
                        );
                    },
                },
                "!starts": {
        ...
        G = (function () {
                        ...
                        for (var b = 0, d = a.criteria; b < d.length; b++)
                            (a = d[b]),
                                void 0 !== a.logic
                                    ...
                                    : void 0 === a.logic &&
                                      this._addPrevCriteria(a);
                    b = 0;
                    for (d = this.s.criteria; b < d.length; b++)
                        (a = d[b]),
                            a.criteria instanceof r &&
                                (a.criteria.updateArrows(
                                    1 < this.s.criteria.length,
                                    !1,
                                ),
                    ...
                    for (var a = 0; a < this.s.criteria.length; a++) {
                        ...
                        b instanceof r
                            ? ((this.s.criteria[a].index = a),
                              ...
                              this.s.criteria[
                                  a
                              ].criteria.dom.container.insertBefore(
                                  this.dom.add,
                              ),
            ...
            c.prototype.setListeners = function () {
                ...
                this.dom.add.on("click.dtsb", function () {
                    a.s.isChild ||
                        a.dom.container.prepend(a.dom.logicContainer);
                    a.addCriteria();
                ...
                for (var f = 0; f < this.s.criteria.length; f++)
                    0 === f && this.s.criteria[f].criteria.s.index > e.s.index
                        ? (e
                              .getNode()
                              .insertBefore(
                                  this.s.criteria[f].criteria.dom.container,
                              ),
                          (a = !0))
            ...
            c.prototype._removeCriteria = function (a, b) {
                void 0 === b && (b = !1);
                if (1 >= this.s.criteria.length && this.s.isChild)
                    this.destroy();
                else {
            ...
            c.prototype._setClearListener = function () {
                ...
                this.dom.clear.unbind("click").on("click.dtsb", function () {
                    if (!a.s.isChild)
                        return (
                            a.dom.container.trigger("dtsb-clearContents"), !1
                        );
                    a.destroy();
                    ...
                    if (this.s.dt.page.info().serverSide)
                        this.s.dt.on("preXhr.dtsb", function (e, f, g) {
                            (e = d.s.dt.state.loaded()) &&
                                e.searchBuilder &&
                                (g.searchBuilder = d._collapseArray(
                                    e.searchBuilder,
                                ));
                        });
                    ...
                    var d = function (n) {
                            void 0 !== n.criteria
                                ...
                                : e.s.dt.columns().every(function (q) {
                                      b.s.dt.settings()[0].aoColumns[q]
                                          .sTitle === n.data && (n.dataIdx = q);
                                  });
                        },
                        e = this,
                        f = 0,
            ...
            c.prototype._setUp = function (a) {
                ...
                if (!C.DateTime) {
                    ...
                    if (void 0 === d || d.includes(void 0) || d.includes(null))
                        x.fn.dataTable.ext.oApi._fnColumnTypes(
                            this.s.dt.settings()[0],
                        ),
        ...
        c.fn.dataTable.ext.buttons.searchBuilder = {
            action: function (f, g, n, q) {
                ...
                void 0 !== q._searchBuilder.s.topGroup &&
                    q._searchBuilder.s.topGroup.dom.container.trigger(
                        "dtsb-redrawContents",
                    );
            ...
            init: function (f, g, n) {
                ...
                f.button(g).text(
                    n.text ||
                        f.i18n("searchBuilder.button", q.c.i18n.button, 0),
                );
                n._searchBuilder = q;
            },
            text: null,
