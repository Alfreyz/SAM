...
(function (c) {
    ...
    c.extend(r.prototype, {
        ...
        _drawSelection: function (a, d) {
            ...
            if (
                b.cell(m).any() &&
                -1 !== b.columns(this.c.columns).indexes().indexOf(a)
            ) {
                this.s.end = f;
                b = d.row < f.row ? e : m;
        ...
        _editor: function (a) {
            ...
            if (b) {
                for (
                    var e = {}, f = [], m = b.fields(), n = 0, p = a.length;
                    n < p;
                    n++
                )
            ...
            if ("focus" === e)
                ...
                c(d.table().body())
                    ...
                    .on("mouseleave" + b, function (f) {
                        c(f.relatedTarget).hasClass("dt-autofill-handle") ||
                            a._detach();
                    });
        },
        ...
        _mousedown: function (a) {
            ...
            this.s.start = {
                row: b
                    .rows({ page: "current" })
                    .nodes()
                    .indexOf(c(this.dom.start).parent()[0]),
        ...
        _shiftScroll: function (a) {
            ...
            null !== b.dtTop && a.pageY < b.dtTop + 65
                ? (q = -5)
                : null !== b.dtTop &&
                  a.pageY > b.dtTop + b.dtHeight - 65 &&
                  (q = 5);
            null !== b.dtLeft && a.pageX < b.dtLeft + 65
                ? (v = -5)
                : null !== b.dtLeft &&
                  a.pageX > b.dtLeft + b.dtWidth - 65 &&
                  (v = 5);
            n || p || q || v
                ? ((b.windowVert = n),
                  (b.windowHoriz = p),
