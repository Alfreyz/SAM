                    ...
                    (t.prototype.initialize = function () {
                        ...
                        this.filterControls.on("click", function (e) {
                            ...
                            this.multiFilterControls.on("click", function (e) {
                                var n =
                                    e.target.getAttribute("data-multifilter");
                                t.toggleFilter(n);
                            }),
        ...
        var S,
            ...
            J = (function (t) {
                function e(e, n) {
                    ...
                    return (
                        ((i = t.call(this, e, n) || this).styledNode = new Q(
                            e,
                            n,
                        )),
                    ...
                    (e.prototype.bindEvents = function () {
                        ...
                        this.eventReceiver.on(
                            ...
                            a(
                                function (e) {
                                    if (
                                        Array.from(e.target.classList).reduce(
                                            function (t, e) {
                ...
                function t(t, e) {
                    ...
                    (this.filterContainer = t),
                        (this.node =
                            ...
                            (i.src =
                                "data:image/svg+xml;base64," + window.btoa(r)),
                            (i.alt = "Spinner"),
                            i)),
                ...
                switch (o) {
                    ...
                    case i.SAME_HEIGHT:
                        return (function (t, e, n) {
                            var r = e.map(function (t, r) {
                                ...
                                o = e.map(function (o, s) {
                                    var a = o.height,
                                        u = Math.floor(r[s] / t);
                                    return {
                                        left: e.slice(i[u], s).reduce(function (
                                            t,
                                            e,
                                        ) {
                                            return t + e.width + n;
                            ...
                            return {
                                containerHeight:
                                    Object.keys(i).length * (e[0].height + n) +
                                    n,
                                itemsPositions: o,
                            };
                        })(t, e, r);
            ...
            t.fn.filterizr = function () {
                ...
                if (
                    ...
                    switch (i) {
                        ...
                        case "destroy":
                            return (
                                s.destroy.apply(s, o), delete this._fltr, this
                            );
                        default:
                            throw new Error(
                                "Filterizr: " +
                ...
                function t(t, e) {
                    ...
                    (this.windowEventReceiver = new y(window)),
                        ...
                        (this.imagesHaveLoaded =
                            !this.filterContainer.node.querySelectorAll("img")
                                .length),
