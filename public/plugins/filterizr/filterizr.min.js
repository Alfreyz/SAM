    ...
    return (function (t) {
                    ...
                    void 0 ===
                        (i = function (t) {
                            return (function (t, e) {
                                ...
                                return (
                                    (s.prototype.addElementBackgroundImages =
                                        function (t) {
                                    ...
                                    (u.prototype.getIsImageComplete =
                                        function () {
                                            return (
                                                this.img.complete &&
        ...
        function (t, e, n) {
                ...
                y = (function () {
                    ...
                    return (
                        ...
                        (t.prototype.removeAllEvents = function (t) {
                            var e = this;
                            Object.keys(this.eventDictionary).forEach(
                                function (n) {
            ...
            function I(t, e) {
                var n = e.get(),
                    r = n.delay;
                return "progressive" === n.delayMode
                    ? r * t
                    : t % 2 == 0
                      ? r
                      : 0;
            ...
            var S,
                ...
                q = (function (t) {
                    ...
                    return (
                        ...
                        (e.prototype.updateWidthWithTransitionsDisabled =
                            function () {
                ...
                J = (function (t) {
                    function e(e, n) {
                        ...
                        return (
                            ((i = t.call(this, e, n) || this).styledNode =
                                new Q(e, n)),
                            ...
                            (this.node =
                                ...
                                (i =
                                    document.createElement(
                                        "img",
                                    )).classList.add("Filterizr__spinner"),
                                (i.src =
                    ...
                    return (
                                ...
                                return nt(this, function (t) {
                                    switch (t.label) {
                                        ...
                                        case 1:
                                            return (
                                                t.sent(),
                                                this.filterContainer.node.removeChild(
                                                    this.node,
                                                ),
                                                [2]
                                            );
                        ...
                        (t.prototype.initialize = function () {
                            this.styles.initialize(),
                                this.filterContainer.node.appendChild(
                                    this.node,
                                );
                        }),
                        t
                ...
                ct = (function () {
                    ...
                    return (
                        ...
                        (t.prototype.findNode = function (t, e, n) {
                            return t.used
                                ? this.findNode(t.right, e, n) ||
                                      this.findNode(t.down, e, n)
                                : e <= t.w && n <= t.h
                                  ? t
                                  : null;
                        }),
            ...
            function ft(t) {
                ...
                t.fn.filterizr = function () {
                    var e =
                            "." +
                            t.trim(this.get(0).className).replace(/\s+/g, "."),
                        n = arguments;
                    if (
                    ...
                    function t(t, e) {
                        ...
                        (this.windowEventReceiver = new y(window)),
                            ...
                            (this.imagesHaveLoaded =
                                !this.filterContainer.node.querySelectorAll(
                                    "img",
                                ).length),
                    ...
                    return (
                        ...
                        (t.prototype.destroy = function () {
                            ...
                            this.filterContainer.destroy(),
                                t.destroy(),
                                this.options.areControlsEnabled &&
                                    e &&
                                    e.destroy();
                        }),
                            ...
                            return ht(this, void 0, void 0, function () {
                                return pt(this, function (e) {
                                    switch (e.label) {
                                        case 0:
                                            return (
                                                this.filterContainer.insertItem(
                                                    t,
                                                ),
                        ...
                        (t.prototype.setOptions = function (t) {
                            var e = this.filterContainer,
                                n = this.filterItems,
                                r =
                                    "animationDuration" in t ||
                                    "delay" in t ||
                                    "delayMode" in t;
                            (t.callbacks || r) && e.unbindEvents(),
                                this.options.set(t),
                                (t.easing || r) &&
                                    n.styles.updateTransitionStyle(),
                                (t.callbacks || r) && e.bindEvents(),
                                "searchTerm" in t && this.search(t.searchTerm),
                                ("filter" in t ||
                                    "multifilterLomultifilterLogicalOperator" in
                                        t) &&
