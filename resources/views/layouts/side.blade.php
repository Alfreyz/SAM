<nav class="col-md-2">
    <div class="sidebar-sticky" style="height: 100%; width: 12%; background-color: #ffffff">
        ...
        <h1 class="text-center text-muted my-2">{{ Auth::user()->idn }}</h1>
        <ul class="nav flex-column">
            ...
            <div class="mt-auto" style="width: 100%; position: absolute; bottom: 0;">
                <button class="btn w-100" style="background-color: #fd6161"><a class="nav-link text-dark"
